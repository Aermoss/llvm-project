//===-- ZodiacAluCode.h - ALU operator encoding ----------------------------===//
//
...
#ifndef LLVM_LIB_TARGET_ZODIAC_ZODIACALUCODE_H
#define LLVM_LIB_TARGET_ZODIAC_ZODIACALUCODE_H
...
const int Zodiac_PRE_OP = 0x40;
const int Zodiac_POST_OP = 0x80;

inline static unsigned encodeZodiacAluCode(unsigned AluOp) {
...
inline static const char *zodiacAluCodeToString(unsigned AluOp) {
...
inline static AluCode stringToZodiacAluCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_ZODIAC_ZODIACALUCODE_H
