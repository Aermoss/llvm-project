//= ZodiacInstPrinter.h - Convert Zodiac MCInst to asm syntax -------*- C++ -*--//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a Zodiac MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_ZODIAC_MCTARGETDESC_ZODIACINSTPRINTER_H
#define LLVM_LIB_TARGET_ZODIAC_MCTARGETDESC_ZODIACINSTPRINTER_H
...
class ZodiacInstPrinter : public MCInstPrinter {
public:
  ZodiacInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
...
#endif // LLVM_LIB_TARGET_ZODIAC_MCTARGETDESC_ZODIACINSTPRINTER_H
