//===- ZodiacInstrInfo.h - Zodiac Instruction Information ---------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_ZODIAC_ZODIACINSTRINFO_H
#define LLVM_LIB_TARGET_ZODIAC_ZODIACINSTRINFO_H
...
class ZodiacSubtarget;

class ZodiacInstrInfo : public ZodiacGenInstrInfo {
  const ZodiacRegisterInfo RegisterInfo;

public:
  ZodiacInstrInfo(const ZodiacSubtarget &STI);

  // getRegisterInfo - TargetInstrInfo is a superset of MRegister info.  As
  // such, whenever a client has an instance of instruction info, it should
  // always be able to get register info as well (through this method).
  virtual const ZodiacRegisterInfo &getRegisterInfo() const {
    return RegisterInfo;
  }
  ...
  // efficient. E.g., on Zodiac register-register instructions can set the flag
