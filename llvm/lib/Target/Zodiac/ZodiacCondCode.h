...
#ifndef LLVM_LIB_TARGET_ZODIAC_ZODIACCONDCODE_H
#define LLVM_LIB_TARGET_ZODIAC_ZODIACCONDCODE_H
...
inline static StringRef zodiacCondCodeToString(LPCC::CondCode CC) {
  switch (CC) {
  case LPCC::ICC_T:
    return "t"; // true
  case LPCC::ICC_F:
...
inline static CondCode suffixToZodiacCondCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_ZODIAC_ZODIACCONDCODE_H
